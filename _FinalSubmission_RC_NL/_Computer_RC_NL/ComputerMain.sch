...
<drawing version="7">
    ...
    <netlist>
        ...
        <blockdef name="MainMem">
            <timestamp>2018-11-30T0:29:58</timestamp>
        ...
        <blockdef name="KeypadInput">
            <timestamp>2018-11-30T1:10:4</timestamp>
        ...
        <blockdef name="sseg_mux4D">
            <timestamp>2018-11-30T0:39:42</timestamp>
        ...
        <blockdef name="sel_strobeB">
            <timestamp>2018-11-30T0:42:11</timestamp>
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <branch name="XLXN_1(7:0)">
            <wire x2="1280" y1="464" y2="464" x1="1008" />
        </branch>
        <instance x="592" y="688" name="XLXI_2" orien="R0">
        </instance>
        <branch name="XLXN_2(7:0)">
            <wire x2="1136" y1="560" y2="560" x1="1008" />
            <wire x2="1136" y1="528" y2="560" x1="1136" />
            <wire x2="1280" y1="528" y2="528" x1="1136" />
        </branch>
        <branch name="SYS_CLK">
            <wire x2="592" y1="464" y2="464" x1="560" />
        </branch>
        <iomarker fontsize="28" x="560" y="464" name="SYS_CLK" orien="R180" />
        <branch name="ROW(3:0)">
            <wire x2="592" y1="528" y2="528" x1="560" />
        </branch>
        <iomarker fontsize="28" x="560" y="528" name="ROW(3:0)" orien="R180" />
        <branch name="WriteTemp">
            <wire x2="592" y1="592" y2="592" x1="560" />
        </branch>
        <iomarker fontsize="28" x="560" y="592" name="WriteTemp" orien="R180" />
        <branch name="Byte_Switch(1:0)">
            <wire x2="592" y1="656" y2="656" x1="560" />
        </branch>
        <iomarker fontsize="28" x="560" y="656" name="Byte_Switch(1:0)" orien="R180" />
        <branch name="COL(3:0)">
            <wire x2="1040" y1="656" y2="656" x1="1008" />
        </branch>
        <iomarker fontsize="28" x="1040" y="656" name="COL(3:0)" orien="R0" />
        ...
        <branch name="sseg(7:0)">
            <wire x2="3168" y1="2416" y2="2416" x1="3136" />
        </branch>
        ...
        <iomarker fontsize="28" x="3168" y="2032" name="anO(3:0)" orien="R0" />
        <iomarker fontsize="28" x="3168" y="2416" name="sseg(7:0)" orien="R0" />
        <branch name="XLXN_34(0:1)">
            <wire x2="2752" y1="2352" y2="2352" x1="2624" />
        </branch>
        ...
        <branch name="XLXN_36">
            <wire x2="2512" y1="2032" y2="2064" x1="2512" />
        ...
        <text style="fontsize:36;fontname:Arial" x="384" y="868">NOTE: Should remove DCM_50M from 'KeypadInput'</text>
        <text style="fontsize:36;fontname:Arial" x="508" y="908">Should be moved out into main .sch file</text>
        <branch name="Update(3:0)">
            <wire x2="1040" y1="720" y2="720" x1="1008" />
        </branch>
        <iomarker fontsize="28" x="1040" y="720" name="Update(3:0)" orien="R0" />
